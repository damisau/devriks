...
//
// NOTE: This static code cannot call methods on the sfGuardUserPermissionPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the sfGuardUserPermissionPeer class:
//
// Propel::getDatabaseMap(sfGuardUserPermissionPeer::DATABASE_NAME)->addTableBuilder(sfGuardUserPermissionPeer::TABLE_NAME, sfGuardUserPermissionPeer::getMapBuilder());
//
