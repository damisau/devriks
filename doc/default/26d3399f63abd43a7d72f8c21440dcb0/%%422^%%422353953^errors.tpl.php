<?php /* Smarty version 2.6.0, created on 2009-01-10 13:40:22
...
unset($_smarty_tpl_vars);
  if (isset($this->_sections['files'])) unset($this->_sections['files']);
...
<?php endfor; endif;  if (count($_from = (array)$this->_tpl_vars['all'])):
...
<br>
<?php endfor; endif;  endif;  if (count ( $this->_tpl_vars['issues']['errors'] )): ?>
<h2>Errors:</h2><br>
...
<br>
<?php endfor; endif;  endif;  endforeach; unset($_from); endif;  $_smarty_tpl_vars = $this->_tpl_vars;
