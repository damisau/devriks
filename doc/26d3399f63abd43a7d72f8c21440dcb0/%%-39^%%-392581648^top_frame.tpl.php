<?php /* Smarty version 2.6.0, created on 2009-01-10 00:51:59
         compiled from top_frame.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'top_frame.tpl', 21, false),)), $this); ?>
<?php echo '<?xml'; ?>
...
" target="right"><?php echo $this->_tpl_vars['ric'][$this->_sections['ric']['index']]['name']; ?>
              ...
              <td style="text-align: right">
								<?php if (count ( $this->_tpl_vars['packages'] ) > 1): ?>
									<?php echo smarty_function_assign(array('var' => 'last_package_name','value' => ""), $this);?>
...
?>
										<?php if ($this->_tpl_vars['last_package_name'] != ""): ?> | <?php endif; ?>
										<a href="<?php echo $this->_tpl_vars['packages'][$this->_sections['p']['index']]['link']; ?>
" target="left_bottom"><?php echo $this->_tpl_vars['packages'][$this->_sections['p']['index']]['title']; ?>
</a>
										<?php echo smarty_function_assign(array('var' => 'last_package_name','value' => $this->_tpl_vars['packages'][$this->_sections['p']['index']]['title']), $this);?>
