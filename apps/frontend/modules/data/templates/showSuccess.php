...
<div id="content">
    <div id="exportBox">
        ...
        <?php
        if(sizeof($indicatorClassnames) == 1 && sizeof($arrangementIds) < 9 && sizeof($years) > 1) {
            ?>
        <a href="/riks/web/graphs/<?php echo $name; ?>.png" target="_blank">
            ...
            ?>In order to export the data as a graph, select one indicator, a maximum of 8 arrangements
        and at least two years.<br><br>
            <?php }

        ?>

        <a href="/devriks/web/graphs/<?php echo $name; ?>.xls" target="_blank">
