...
/**
 * RikssymTraining filter form base class.
 *
 * @package    riks
 * @subpackage filter
 ...
 */
class BaseRikssymTrainingFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('rikssym_training_filters[%s]');
