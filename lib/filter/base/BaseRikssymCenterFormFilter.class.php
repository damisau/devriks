...
/**
 * RikssymCenter filter form base class.
 *
 * @package    riks
 * @subpackage filter
 ...
 */
class BaseRikssymCenterFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('rikssym_center_filters[%s]');
