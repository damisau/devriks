 ...
 */
class BaseRikssymMasterForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'            => new sfValidatorPropelChoice(array('model' => 'RikssymMaster', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('rikssym_master[%s]');
