 ...
 */
class BaseRikssymPhdForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'            => new sfValidatorPropelChoice(array('model' => 'RikssymPhd', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('rikssym_phd[%s]');
